...
//     const navigate = useNavigate()
//     const urlParams = new URLSearchParams(window.location.search)
//     const initialTab = urlParams.get('tab') || 'adaccount' // 'adaccount' is the new default
//     const preselectedAdAccount = urlParams.get('adAccount')
//     const [activeTab, setActiveTab] = useState(initialTab)

//     // Removed 'global' from tab maps
//     const tabIconMap = {
//         adaccount: Folder,
//         billing: Card,
//         viewads: ViewAdsIcon,
...
//                         {/* Tab Buttons - Removed 'global' from the array */}
//                         <div className="space-y-2">
...
//                             <div className="w-full">
//                                 {/* Removed the GlobalSettings component render */}
//                                 {activeTab === "adaccount" && <AdAccountSettings preselectedAdAccount={preselectedAdAccount} />}
//                                 {activeTab === "viewads" && <ViewAds />}
//                                 {activeTab === "billing" && <BillingSettings />}
//                             </div>
