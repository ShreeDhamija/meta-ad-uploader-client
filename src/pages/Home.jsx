    ...
    return (
        ...
        <>
            ...
            <div className="w-full max-w-[1600px] mx-auto py-8 px-2 sm:px-4 md:px-6">
                <Header isLoggedIn={isLoggedIn} userName={userName} handleLogout={handleLogout} showMessenger={showMessenger} hideMessenger={hideMessenger} metaNotLinked={!isLoggedIn} />
                <div className="flex flex-col lg:flex-row gap-6 min-w-0">
                    <div className={`flex-1 lg:flex-[55] min-w-0 space-y-6 ${(!userHasActiveAccess || !isLoggedIn) ? 'pointer-events-none opacity-40 cursor-not-allowed select-none' : ''}`}>
                        <AdAccountSettings
                            isLoading={isLoading}
                    ...
                    <div className={`flex-1 lg:flex-[45] min-w-0 ${(!userHasActiveAccess || !isLoggedIn) ? 'pointer-events-none opacity-40 cursor-not-allowed select-none' : ''}`}>
                        <ErrorBoundary>
                            <MediaPreview
