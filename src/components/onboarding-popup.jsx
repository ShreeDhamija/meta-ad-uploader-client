...
export default function OnboardingPopup({ userName, onClose, onGoToSettings }) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
            <div className="bg-[#FAF9F7] rounded-[24px] shadow-2xl px-8 py-10 w-full max-w-3xl text-center animate-[fadeIn_0.3s_ease-out_forwards]">
                {step === "initial" ? (
                    <>
                    ...
                    <div className="flex flex-col md:flex-row text-left gap-6">
                        ...
                        <div className="flex-1">
                            <img src="https://meta-ad-uploader-server-production.up.railway.app/home.webp" alt="Home Icon" className="w-10 mb-4" />
                            <h2 className="text-xl font-semibold text-gray-900 mb-6">Home Page</h2>
