...
export default function AdAccountSelectionPopup({ isOpen, onClose, onSave, selectedAdAccountIds }) {
    ...
    const maxAccounts = isStarterPlan ? 1 : (isBrandPlan ? 3 : Infinity)
    ...
    const getDialogDescription = () => {
        if (isStarterPlan) {
            ...
            return "As a Light plan subscriber, you can use up to 3 ad accounts. Please select which accounts you'd like to use."
        }
