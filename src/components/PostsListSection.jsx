...
export default function PostsListSection({
    ...
    // Toggle post selection - updates importedPosts (array of IDs) in parent
    ...
    const isSelected = (postId) => importedPosts.includes(postId)

    // Count of selected posts from current fetched posts
    const selectedCount = posts.filter(p => isSelected(p.id)).length
        ...
        <div className="space-y-4">
            ...
            {hasFetched && (
                <div className="border border-gray-200 rounded-xl p-3">
                    ...
                    {/* Selection info */}
                    {posts.length > 0 && selectedCount > 0 && (
                        <div className="pt-3 border-t mt-3">
