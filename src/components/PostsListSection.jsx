...
export default function PostsListSection({
    ...
    // Local state - selection is internal, just like the working modal version
    ...
    // Toggle local selection (doesn't touch parent state)
    ...
    // Only update parent when user explicitly clicks "Add Posts"
    const handleAddPosts = () => {
        ...
        toast.success(`Added ${selectedPostIds.size} post(s)`)
        ...
        <div className="space-y-4">
            ...
            {hasFetched && (
                <div className="border border-gray-200 rounded-xl p-3">
                    ...
                    {/* Add Posts button - only updates parent when clicked */}
                    {posts.length > 0 && (
