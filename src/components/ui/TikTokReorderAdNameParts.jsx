...
export default function TikTokReorderAdNameParts({
  formulaInput = "",
  onFormulaChange,
  variant = "default",
  customVariables = [],
  onCustomVariablesChange,
  hideInfoTooltip = false,
  disabled = false,
}) {
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex items-center justify-between">
        <Label className={cn(
          "text-gray-500 text-[12px] leading-5 font-normal block",
      ...
      <div className="relative">
        <Input
          ...
          className={cn(
            ...
            disabled && "bg-gray-100/80 text-gray-400 border-gray-200 cursor-not-allowed shadow-none opacity-80"
          )}
        />
      ...
      {!disabled && categoryWarnings.length > 0 && (
