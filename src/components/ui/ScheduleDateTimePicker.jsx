    ...
    return (
        <div className="space-y-3 rounded-2xl border border-gray-200 bg-gray-50/80 p-4">
            ...
            <div className="flex flex-col gap-3 sm:flex-row">
                ...
                <Popover open={showCal} onOpenChange={setShowCal}>
                    <PopoverTrigger asChild>
                        <button
                            type="button"
                            className={cn(
                                "inline-flex h-11 w-full min-w-0 items-center justify-start gap-2 rounded-2xl border bg-white px-4 text-sm shadow transition-colors sm:flex-1",
                                selectedDate
                ...
                {/* Time Picker */}
                <div className={cn(
                    "flex h-11 w-full items-center gap-1.5 rounded-2xl border bg-white px-2.5 text-sm shadow sm:w-[140px]",
