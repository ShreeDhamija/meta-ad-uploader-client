...
function PostSelectorInline({ adAccountId, onImport, usePostID, setUsePostID }) {
    ...
    return (
        ...
        <div className="flex flex-col h-full overflow-hidden">
            ...
            {/* Header Controls - Always visible when we have ads OR in search mode */}
            {(ads.length > 0 || viewMode === 'search') && (
                <div className="flex-1 min-h-0 flex flex-col overflow-hidden">
                    {/* Header Section - Fixed, never scrolls */}
                    <div className="flex-shrink-0 space-y-3 pb-2">
                        <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center justify-between py-2 px-1">
                            ...
                            <div className="flex items-center gap-1">
                                <Button
                                    ...
                                    className={`px-2 py-1 h-8 rounded-lg ${viewMode === 'list'
                                ...
                                <Button
                                    ...
                                    className={`px-2 py-1 h-8 rounded-lg ${viewMode === 'search'
                                        ? 'bg-blue-500 hover:bg-blue-600 text-white'
                                        : 'border-gray-300 text-gray-500 hover:text-gray-700'
                                        }`}
                        ...
                        {/* Column Headers - Fixed */}
                        {ads.length > 0 && (
                            <div className={`grid ${viewMode === 'search'
                                ? 'grid-cols-[20px_48px_1fr_120px_110px]'
                                : 'grid-cols-[20px_48px_1fr_120px_110px]'
                                } gap-2 px-2 py-2 text-xs font-medium text-white bg-blue-500 rounded-xl items-center`}>
                                <div></div>
                                <div className="-ml-4">Thumbnail</div>
                                <div>Ad Name</div>
                                <div>Ad Set</div>
