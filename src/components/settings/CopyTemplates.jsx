...
//         </span>
//         {/* Only show trash icon in dropdown, not in trigger */}
//         <Trash2
//           tabIndex={-1}
//           className="absolute right-2 top-1/2 transform -translate-y-1/2 w-4 h-4 text-gray-400 hover:text-red-500 cursor-pointer data-[state=checked]:hidden"
