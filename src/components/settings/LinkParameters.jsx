    ...
    return (
        <div className="p-4 bg-[#f5f5f5] rounded-xl space-y-4 w-full max-w-3xl">
            ...
            <div className="space-y-3">
                ...
                <p className="text-xs text-gray-500">
                    Select a link for your ads or add new ones. The selected link will be used by default.
                </p>
                ...
                <div className="flex gap-2 items-center">
                    <Popover open={linkDropdownOpen} onOpenChange={setLinkDropdownOpen}>
                        ...
                        <PopoverContent className="w-full p-0 bg-white shadow-lg rounded-xl" align="start">
                            <Command>
                ...
                {showAddForm ? (
                    ...
                    <Button
                        ...
                        variant="outline"
                        className="w-full rounded-xl border-dashed border-gray-300 hover:border-gray-400"
                    >
