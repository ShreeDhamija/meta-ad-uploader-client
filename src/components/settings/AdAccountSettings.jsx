...
import DefaultAdStatus from "./DefaultAdStatus"
...
const PIXEL_TRACKING_ALLOWED_USER_IDS = ["10236978990363167", "10234447959963619", "10163794086700369", "122113601127356755", "10162737276661695", "10165258246808665", "10163704737102804", "28883613861256118"];
...
export default function AdAccountSettings({ preselectedAdAccount, onTriggerAdAccountPopup, subscriptionData }) {
  ...
  const [defaultAdStatus, setDefaultAdStatus] = useState("ACTIVE")
