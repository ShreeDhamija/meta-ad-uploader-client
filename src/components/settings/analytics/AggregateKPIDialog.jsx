 ...
 *  - adAccounts: [{ id, name }]
 *  - adAccountSettings: map of accountId -> settings (for analyticsMode)
 */
export default function AggregateKPIDialog({ open, onOpenChange, adAccounts }) {
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            ...
            <DialogContent className="sm:max-w-[960px] !rounded-[30px] p-8 space-y-5 max-h-[90vh] overflow-y-auto">
    ...
    return (
        <div className="border border-gray-200 rounded-2xl p-3 bg-white">
            ...
            {isLoading ? (
                ...
                <div className="flex items-center justify-center h-[100px] text-[10px] text-gray-300">
                    No data
                </div>
            ) : (
