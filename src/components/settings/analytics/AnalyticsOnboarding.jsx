...
//     return (
//         <Dialog open={open} onOpenChange={() => { /* prevent close via overlay */ }}>
//             <DialogOverlay className="bg-black/50" />
//             <DialogContent
//                 className="sm:max-w-[560px] !rounded-[30px] p-8 space-y-5 max-h-[90vh] overflow-y-auto"
...
//                     </DialogTitle>
//                     <DialogDescription>
//                         Choose whether each ad account is optimized for CPA (cost per action) or ROAS (return on ad spend). You can change this later in settings.
//                     </DialogDescription>
//                 </DialogHeader>
...
//                         onClick={handleSave}
//                         disabled={saving}
//                         className="w-full rounded-2xl bg-blue-600 hover:bg-blue-700 h-11"
//                     >
//                         {saving ? (
//                             <>
            ...
            >
                ...
                <DialogFooter className="pt-2 flex gap-3">
                    ...
                    <Button
                        onClick={handleSave}
                        disabled={saving}
                        className="flex-1 rounded-2xl bg-blue-600 hover:bg-blue-700 h-11"
                    >
                        {saving ? (
                            <>
                                <Loader2 className="w-4 h-4 mr-2 animate-spin" />
