            ...
            {showSettingsDialog && (
                <>
                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                        <div
                            className="bg-white rounded-[28px] shadow-2xl w-full max-w-[520px] max-h-[90vh] overflow-y-auto p-8 space-y-6"
                        ...
                        >
                            ...
                            <div className="flex gap-3 pt-4">
                                <button
                                    onClick={() => setShowSettingsDialog(false)}
                                    className="flex-1 py-3 px-4 border border-gray-300 rounded-2xl text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors"
                                >
                                    Cancel
                                </button>
                                <button
                                    onClick={handleSaveSettings}
                                    className="flex-1 py-3 px-4 bg-blue-600 hover:bg-blue-700 text-white rounded-2xl text-sm font-medium transition-colors"
                                >
                                    Save Settings
                                </button>
                            </div>
