...
export default function AdCreationForm({
  ...
  useEffect(() => {
    ...
    const processThumbnails = async () => {
      // Process 3-4 at a time with proper concurrency control
      const CONCURRENCY = 3;
      let completed = 0;
  ...
  }, [files, generateThumbnail]); // videoThumbs removed!

  // Drive files effect (instant, no limit needed)
  useEffect(() => {
  ...
  const handleCreateAd = async (jobData) => {
    ...
    try {
      const promises = [];
      // Note: frontendJobId should already be defined in your component/context
      // const frontendJobId = ...; // Make sure this exists before this code block
