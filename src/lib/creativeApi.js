...
export const creativeApi = {
  ...
  runIngest: (productId, aiSelections) => request("/context/ingest", { method: "POST", body: { productId, aiSelections } }),
  ...
  importBrandAssets: (productId, url, aiSelections) => request(`/products/${encodeURIComponent(productId)}/assets/import`, { method: "POST", body: { url, aiSelections } }),
  ...
  runInsights: (productId, aiSelections) => request("/insights/run", { method: "POST", body: { productId, aiSelections } }),
  ...
  runResearch: (productId, aiSelections) => request("/research/run", { method: "POST", body: { productId, aiSelections } }),
  ...
  runLibrary: (productId, aiSelections) => request("/library/run", { method: "POST", body: { productId, aiSelections } }),
  ...
  runWeekly: (clientId, aiSelections) => request("/weekly/run", { method: "POST", body: { clientId, aiSelections } }),
  ...
  generateBrief: (ideaId, productId, aiSelections) =>
    request(`/weekly/ideas/${encodeURIComponent(ideaId)}/brief`, { method: "POST", body: { productId, aiSelections } }),
